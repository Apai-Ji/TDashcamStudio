...
> **This is a personal fork** of [DeaglePC/TDashcamStudio](https://github.com/DeaglePC/TDashcamStudio),
> licensed under AGPL-3.0. Changes on top of upstream: precise clip range selection
> (typed in/out times, keyboard shortcuts, fine dragging, range preview).
> Release builds here are Windows-only; use upstream for macOS and Linux.
