...
> **这是 [DeaglePC/TDashcamStudio](https://github.com/DeaglePC/TDashcamStudio) 的个人 fork**，
> 遵循 AGPL-3.0 许可证。相对上游的改动：剪辑范围精确选取（可直接输入起止时间、键盘快捷键、
> 精细拖动、选段预览）。这里的 Release 只构建 Windows 版，macOS 和 Linux 请用上游。
